<template>
  <div class="flex-1 bg-linear-to-br from-white via-slate-50 to-slate-100 dark:from-slate-800 dark:via-slate-700 dark:to-slate-800 relative">
    <div v-if="currentTab" class="h-full">
      <div 
        v-if="currentTab.url && currentTab.url !== 'about:blank'"
        class="w-full h-full bg-linear-to-br from-white/90 via-slate-50/90 to-slate-100/90 dark:from-slate-800/90 dark:via-slate-700/90 dark:to-slate-800/90 backdrop-blur-sm flex items-center justify-center"
      >
      ...
      <div v-else class="h-full flex items-center justify-center bg-linear-to-br from-slate-100/80 via-white/80 to-slate-200/80 dark:from-slate-700/80 dark:via-slate-600/80 dark:to-slate-700/80">
